...
uses
  System.SysUtils, ClsCandidatoControl, ClsQuestionario, ClsParametros,
  ClsServidorControl,
  ClsOper200100, ClsOper200110, ClsOper200500, ClsOper200200, ClsOper200710,
  ClsOperacoes;
...
begin
  ...
  Result.MontaRetorno(Consulta.Consultar(IntToStr(ParServidor.ID_Sistema),
...
begin
  ...
  Result.MontaRetorno(Consulta.Consultar(IntToStr(ParServidor.ID_Sistema),
    Oper200100Env.MontaXMLEnvio(ParCandidato.TipoProva,
    ParCandidato.IdCandidato, Parametros.Identificacao,
    Parametros.Computador)));
...
begin
  ...
  Result.MontaRetorno(Consulta.Consultar(IntToStr(ParServidor.ID_Sistema),
    Oper200110Env.MontaXMLEnvio(IntToStr(ParQuestionario.Id_prova),
