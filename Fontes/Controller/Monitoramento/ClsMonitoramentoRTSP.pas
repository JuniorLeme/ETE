...
begin
  ...
  try
    ...
    begin
      ...
      ArquivoLog.GravaArquivoLog
        ('Monitoramento - SendSocketComand => Argumento: ' + Arg + ' Host: ' +
        Self.Host + #13 + 'Porta: ' + IntToStr(Self.Port) + ' Retorno: ' +
        IntToStr(intReturnCode) + ' Falha: ' + E.Message);
    end;
  end;
  ...
  begin
    ...
    ArquivoLog.GravaArquivoLog('Monitoramento - Argumento: ' + Arg + ' Host: ' +
      Self.Host + #13 + 'Retorno: ' + Result);
