...
uses System.SysUtils, System.Classes;
   ...
   Function Frm_Login_XML591804: WideString;
   Function Frm_IdentificaCandidato_XML591804: WideString;
   Function frm_CadastroCandidato_XML591804: WideString;
   Function Frm_Foto_XML591804: WideString;
   Function Frm_BiometriaFotos_XML591804: WideString;
   Function Frm_Informacoes_XML591804 : WideString ; export;
   Function Frm_Confirmacao_XML591804: WideString;
   Function frm_Flash_XML591804: WideString;
   Function Frm_Questionario_XML591804: WideString;
   Function Frm_Resultado_XML591804: WideString;

implementation


Function Frm_Login_XML591804 : WideString ; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>'+
            '<Frm_Login ClientHeight="268" ClientWidth="486" Caption="e-CFCAnet XE">'+
            '<Label1 tipo="TLabel" Left="24" Top="76" ClientHeight="13" ClientWidth="80" Caption="Nome de usuário"></Label1>'+
            '<Label2 tipo="TLabel" Left="24" Top="122" ClientHeight="13" ClientWidth="30" Caption="Senha"></Label2>'+
            '<Image1 tipo="TImage" Left="272" Top="91" ClientHeight="74" ClientWidth="192" ImageResource="LogoSP"></Image1>'+
            '<Label3 tipo="TLabel" Left="24" Top="168" ClientHeight="13" ClientWidth="59" Caption="Computador"></Label3>'+
            '<SpeedButton1 tipo="TSpeedButton" Left="103" Top="212" ClientHeight="29" ClientWidth="113"></SpeedButton1>'+
            '<Label4 tipo="TLabel" Left="24" Top="8" ClientHeight="25" ClientWidth="153" Caption="Seja bem-vindo!"></Label4>'+
            '<Label5 tipo="TLabel" Left="24" Top="39" ClientHeight="13" ClientWidth="228" Caption="Identifique-se por favor para utilizar o e-CFCAnet."></Label5>'+
            '<SpeedButton2 tipo="TSpeedButton" Left="264" Top="212" ClientHeight="29" ClientWidth="113"></SpeedButton2>'+
            '<Image2 tipo="TImage" Left="24" Top="246" ClientHeight="16" ClientWidth="16"></Image2>'+
            '<EdUsuario tipo="TButtonedEdit" Left="24" Top="91" ClientHeight="17" ClientWidth="188"></EdUsuario>'+
            '<EdSenha tipo="TButtonedEdit" Left="24" Top="137" ClientHeight="17" ClientWidth="188"></EdSenha>'+
            '<EdComputador tipo="TButtonedEdit" Left="24" Top="183" ClientHeight="17" ClientWidth="55"></EdComputador>'+
            '</Frm_Login>';
end;

Function Frm_IdentificaCandidato_XML591804 : WideString ; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?><Frm_IdentificaCandidato ClientHeight="430"'+
            ' ClientWidth="583" Caption="e-CFCAnet XE"><Label1 tipo="TLabel" Left="24" Top="69"'+
            ...
            ' ImageResource="LogoSP"/><Image1 tipo="TImage" Left="52" Top="408" ClientHeight="16"'+
...
Function frm_CadastroCandidato_XML591804 : WideString ; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>'+
            '<frm_CadastroCandidato ClientHeight="430" ClientWidth="583" Caption="e-Prova XE">'+
            '<Label9 tipo="TLabel" Left="24" Top="8" ClientHeight="25" ClientWidth="176"'+
            ' Caption="Cadastro do aluno."/><Label10 tipo="TLabel" Left="24" Top="39"'+
            ' ClientHeight="13" ClientWidth="246" Caption="Cadastra o aluno que vai realizar a prova simulada."/>'+
            '<SBtProva tipo="TSpeedButton" Left="239" Top="379" ClientHeight="29" ClientWidth="137"/>'+
            '<SBtSimulado tipo="TSpeedButton" Left="24" Top="379" ClientHeight="29" ClientWidth="137"/>'+
            '<SpeedButton2 tipo="TSpeedButton" Left="464" Top="379" ClientHeight="29" ClientWidth="95"/>'+
            '<Label1 tipo="TLabel" Left="24" Top="69" ClientHeight="13" ClientWidth="41" Caption="CPF"/>'+
            '<Label2 tipo="TLabel" Left="24" Top="115" ClientHeight="13" ClientWidth="19" Caption="RENACH"/>'+
            '<Label3 tipo="TLabel" Left="24" Top="161" ClientHeight="16" ClientWidth="33" Caption="Nome"/>'+
            '<Label4 tipo="TLabel" Left="24" Top="210" ClientHeight="16" ClientWidth="33" Caption="Curso"/>'+
            '<Label5 tipo="TLabel" Left="24" Top="259" ClientHeight="16" ClientWidth="39" Caption="Cidade"/>'+
            '<Label6 tipo="TLabel" Left="24" Top="308" ClientHeight="16" ClientWidth="117" Caption="Data de nascimento "/>'+
            '<Label7 tipo="TLabel" Left="166" Top="308" ClientHeight="16" ClientWidth="28" Caption="Sexo"/>'+
            '<Image3 tipo="TImage" Left="367" Top="134" ClientHeight="74" ClientWidth="192" ImageResource="LogoSP"/>'+
            '<EdRENACH tipo="TButtonedEdit" Left="24" Top="88" ClientHeight="17" ClientWidth="117"/>'+
            '<EditCpf tipo="TEdit" Left="24" Top="134" ClientHeight="17" ClientWidth="117"/>'+
            '<EditNome tipo="TEdit" Left="24" Top="183" ClientHeight="17" ClientWidth="317"/>'+
            '<EditCidade tipo="TEdit" Left="24" Top="281" ClientHeight="17" ClientWidth="317"/>'+
            '<EditNascimento tipo="TEdit" Left="24" Top="330" ClientHeight="17" ClientWidth="113"/>'+
            '<CbBSexo tipo="TComboBox" Left="167" Top="330" ClientHeight="21" ClientWidth="179"/>'+
            '<cbbCurso tipo="TComboBox" Left="24" Top="232" ClientHeight="21" ClientWidth="321"/>'+
            '</frm_CadastroCandidato>';
end;

Function Frm_Foto_XML591804 : WideString ; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>'+
            '<Frm_Foto ClientHeight="486" ClientWidth="642" Caption="e-CFCAnet XE">'+
            ...
            '<Image3 tipo="TImage" Left="14" Top="81" ClientHeight="74" ClientWidth="192" ImageResource="LogoSP"/>'+
...
Function Frm_BiometriaFotos_XML591804 : WideString ; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>'+
            '<Frm_BiometriaFotos ClientHeight="505" ClientWidth="703" Caption="e-CFCAnet XE">'+
...
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>'+
            '<Frm_Informacoes ClientHeight="580" ClientWidth="920" Caption="e-CFCANet">'+
            '<Image1 tipo="TImage" Left="0" Top="0" ClientHeight="580" ClientWidth="920"/>'+
            '<Label1 tipo="TLabel" Left="8" Top="8" ClientHeight="36" ClientWidth="898" Caption="Seja bem-vindo ao Sistema e-CFCANet."/>'+
            ...
            '<Image2 tipo="TImage" Left="3" Top="3" ClientHeight="44" ClientWidth="96" ImageResource="LogoSP"/>'+
            '<Memo1 tipo="TMemo" Left="8" Top="56" ClientHeight="473" ClientWidth="898"/></Frm_Informacoes>';
end;

Function Frm_Confirmacao_XML591804 : WideString ; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>'+
            '<Frm_Confirmacao ClientHeight="581" ClientWidth="921" Caption="e-CFCAnet XE">'+
            ...
            '<Label1 tipo="TLabel" Left="8" Top="16" ClientHeight="18" ClientWidth="898" Caption="Seja bem-vindo ao sistema e-CFCANet."></Label1>'+
            ...
            '<Image2 tipo="TImage" Left="3" Top="3" ClientHeight="44" ClientWidth="96" ImageResource="LogoSP"></Image2>'+
...
Function frm_Flash_XML591804 : WideString ; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>'+
            '<frm_Flash ClientHeight="392" ClientWidth="314" Caption="e-CFCAnet XE">'+
...
Function Frm_Questionario_XML591804 : WideString ; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>'+
            '<Frm_Questionario ClientHeight="651" ClientWidth="994" Caption="e-CFCAnet XE">'+
            ...
            '<Image2 tipo="TImage" Left="3" Top="3" ClientHeight="51" ClientWidth="103" ImageResource="LogoSP"></Image2>'+
            ...
            '<LblPergunta tipo="TLabel" Left="52" Top="519" ClientHeight="13" ClientWidth="48"></LblPergunta>'+
            ...
            '<GridPanel1 tipo="TGridPanel" Left="52" Top="538" ClientHeight="30" ClientWidth="879"></GridPanel1>'+
...
Function Frm_Resultado_XML591804 : WideString ; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>'+
            '<Frm_Resultado ClientHeight="651" ClientWidth="994" Caption="e-CFCAnet XE">'+
            ...
            '<Image2 tipo="TImage" Left="3" Top="4" ClientHeight="51" ClientWidth="105" ImageResource="LogoSP"></Image2>'+
            ...
            '<PageControl1 tipo="TPageControl" Left="255" Top="64" ClientHeight="529" ClientWidth="730"></PageControl1>'+
