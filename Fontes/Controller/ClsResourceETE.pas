...
Function Frm_Login_XML529756: WideString;
Function Frm_IdentificaCandidato_XML529756: WideString;
Function frm_CadastroCandidato_XML529756: WideString;
Function Frm_Foto_XML529756: WideString;
Function Frm_BiometriaFotos_XML529756: WideString;
Function Frm_Informacoes_XML529756: WideString; export;
Function Frm_Confirmacao_XML529756: WideString;
Function frm_Flash_XML529756: WideString;
Function Frm_Questionario_XML529756: WideString;
Function Frm_Resultado_XML529756: WideString;

implementation

Function Frm_Login_XML529756: WideString; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>' +
    '<Frm_Login ClientHeight="268" ClientWidth="486" Caption="ETE Desktop">' +
    ...
    + '<Image1 tipo="TImage" Left="272" Top="91" ClientHeight="74" ClientWidth="192" ImageResource="LogoETE"></Image1>'
    ...
    + '<Label5 tipo="TLabel" Left="24" Top="39" ClientHeight="13" ClientWidth="228" Caption="Identifique-se por favor para utilizar o sistema."></Label5>'
...
Function Frm_IdentificaCandidato_XML529756: WideString; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?><Frm_IdentificaCandidato ClientHeight="430"'
    + ' ClientWidth="583" Caption="ETE Desktop"><Label1 tipo="TLabel" Left="24" Top="69"'
    ...
    + ' ImageResource="LogoETE"/><Image1 tipo="TImage" Left="52" Top="408" ClientHeight="16"'
...
Function frm_CadastroCandidato_XML529756: WideString; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>' +
    '<frm_CadastroCandidato ClientHeight="430" ClientWidth="583" Caption="ETE Desktop">'
    ...
    + '<Image3 tipo="TImage" Left="367" Top="134" ClientHeight="74" ClientWidth="192" ImageResource="LogoETE"/>'
...
Function Frm_Foto_XML529756: WideString; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>' +
    '<Frm_Foto ClientHeight="486" ClientWidth="642" Caption="ETE Desktop">' +
    ...
    + '<Image3 tipo="TImage" Left="14" Top="81" ClientHeight="74" ClientWidth="192" ImageResource="LogoETE"/>'
...
Function Frm_BiometriaFotos_XML529756: WideString; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>' +
    '<Frm_BiometriaFotos ClientHeight="505" ClientWidth="703" Caption="ETE Desktop">'
...
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>' +
    '<Frm_Informacoes ClientHeight="580" ClientWidth="920" Caption="ETE Desktop">'
    + '<Image1 tipo="TImage" Left="0" Top="0" ClientHeight="580" ClientWidth="920"/>'
    + '<Label1 tipo="TLabel" Left="8" Top="8" ClientHeight="36" ClientWidth="898" Caption="Seja bem-vindo ao Sistema ETE Desktop."/>'
    ...
    + '<Image2 tipo="TImage" Left="3" Top="3" ClientHeight="44" ClientWidth="96" ImageResource="LogoETE"/>'
    + '<Memo1 tipo="TMemo" Left="8" Top="56" ClientHeight="473" ClientWidth="898"/></Frm_Informacoes>';
end;

Function Frm_Confirmacao_XML529756: WideString; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>' +
    '<Frm_Confirmacao ClientHeight="581" ClientWidth="921" Caption="ETE Desktop">'
    ...
    + '<Label1 tipo="TLabel" Left="8" Top="16" ClientHeight="18" ClientWidth="898" Caption="Seja bem-vindo ao sistema ETE Desktop."></Label1>'
    ...
    + '<Image2 tipo="TImage" Left="3" Top="3" ClientHeight="44" ClientWidth="96" ImageResource="LogoETE"></Image2>'
...
Function frm_Flash_XML529756: WideString; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>' +
    '<frm_Flash ClientHeight="392" ClientWidth="314" Caption="ETE Desktop">' +
...
Function Frm_Questionario_XML529756: WideString; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>' +
    '<Frm_Questionario ClientHeight="651" ClientWidth="994" Caption="ETE Desktop">'
    ...
    + '<Image2 tipo="TImage" Left="3" Top="3" ClientHeight="51" ClientWidth="103" ImageResource="LogoETE"></Image2>'
...
Function Frm_Resultado_XML529756: WideString; export;
begin
  Result := '<?xml version="1.0" encoding="UTF-8"?>' +
    '<Frm_Resultado ClientHeight="651" ClientWidth="994" Caption="ETE Desktop">'
    ...
    + '<Image2 tipo="TImage" Left="3" Top="4" ClientHeight="51" ClientWidth="105" ImageResource="LogoETE"></Image2>'
